...
public class UserServiceImpl implements UserService {
    ...
    private void resolveRoles(User user) {
        ...
        Set<Role> resolved = new java.util.HashSet<>();
        for (Role role : user.getRoles()) {
            ...
            Role managed = null;
            if (role.getId() != null) {
                managed = roleService.getRoleById(role.getId());
            }
            if (managed == null && role.getName() != null) {
                managed = roleService.getRoleByName(role.getName());
            }
            if (managed != null) {
